...
The 1.0.1 version is deprecated tho', as i personally don't care using systemd-boot on Ubuntu anymore.<br>

NOTE: The 1.0.1 version was tested on a VM and on an actual drive, the 1.1.0 has been tested. :)
